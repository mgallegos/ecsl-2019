...
namespace Mgallegos\ECSL2019\Repositories\RegistrationForm;

use Illuminate\Database\Eloquent\Model;

use Mgallegos\ECSL2019\RegistrationForm;
...
class EloquentRegistrationForm implements RegistrationFormInterface {
   ...
   * @param  int $id
   *
   * @return Mgallegos\ECSL2019\RegistrationForm
   */
   ...
   *                            );
   *
   * @param Mgallegos\ECSL2019\RegistrationForm $RegistrationForm
   *
   * @return boolean
   */
