...
namespace Mgallegos\ECSL2019\Repositories\CardTouch;

use Illuminate\Database\Eloquent\Model;

use Mgallegos\ECSL2019\CardTouch;
...
class EloquentCardTouch implements CardTouchInterface {
   ...
   * @param  int $id
   *
   * @return Mgallegos\ECSL2019\CardTouch
   */
   ...
   *                            );
   *
   * @param Mgallegos\ECSL2019\CardTouch $CardTouch
   *
   * @return boolean
   */
