          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
              <div class="form-group mg-hm">
                ...
                {!! Form::select('trans-to-date', array('2019-07-14' => '14 de julio del 2019','2019-07-15' => '15 de julio del 2019'), null, array('id'=>'trans-to-date', 'class'=>'form-control', 'data-mg-required'=>'')) !!}
