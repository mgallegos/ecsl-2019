...
<head>
  ...
  <script src='https://www.amcharts.com/lib/4/themes/amchartsdark.js'></script>
	...
	<meta name="keywords" content="ECSL2019,SLSV,SV,ecsl-2019,ecsl-2019SV"/>
	<!-- for Facebook -->
	<meta property="og:title" content="{{!empty($ogTitle)?$ogTitle:'Encuentro Centroamericano de Software Libre 2019'}}" />
...
<body id="body" data-spy="scroll" data-target="#sideLogistica">
	<header>
		...
		@include('ecsl-2019::top-bar-inicio')
	</header>
	<main role="main">
		...
		@include('ecsl-2019::main/contact')
		<!-- <div class="site-background-color footer-margin"></div> -->
		@include('ecsl-2019::main/terminosycondiciones')
		@include('ecsl-2019::main/avisoconstruccion')
