      ...
      <tbody>
          ...
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-12 10:10:00')
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-12 11:20:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-12 13:30:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-12 14:40:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-12 15:50:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
      ...
      <tbody>
        ...
        <tr>
          <td class="text-center py-4 table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 08:30:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center py-4 table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 09:40:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center py-4 table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 10:50:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 13:30:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 14:40:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
        ...
        <tr>
          <td class="text-center table-info">
            <div class="row">
              @foreach ($presentationsBySchedule as $index => $presentation)
                @if($presentation['schedule'] == '2019-07-13 15:50:00')
                  @include('ecsl-2019::agenda-item')
                @endif
              @endforeach
            </div>
