...
<header class="masthead">
  <div class="container ">
      ...
      <div class="intro-lead-in font-weight-bold">El X Encuentro Centroamericano de Software Libre (ECSL) se realizó los días 12, 13 y 14 de julio del 2019 en la ciudad de San Salvador, El Salvador.</div>
  </div>
</header>
...
<div class="container wow animated fadeInUp" data-wow-delay="0.5s">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card text-center" >
        ...
        <a href="https://www.youtube.com/watch?v=1pnB9bb7MvE&t=100s" data-toggle="lightbox" data-gallery="youtubevideos">
          <img src="https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_002.jpg" class="card-img-top img-fluid same-height">
        </a>
        ...
        <div class="card-body">
              ...
              <h6 class="card-subtitle mb-2 text-muted">12, 13 y 14 de julio del 2019</h6>
        </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card text-center" >
        ...
        <a href="https://www.youtube.com/watch?v=hPVRG--mDd8" data-toggle="lightbox" data-gallery="youtubevideos">
          <img src="https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_053.jpg" class="card-img-top img-fluid same-height">
        </a>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card text-center" >
        ...
        <a href="https://www.youtube.com/watch?v=a_6zsGWGcZQ" data-toggle="lightbox" data-gallery="youtubevideos">
          <img src="https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_063.jpg" class="card-img-top img-fluid same-height">
        </a>
  ...
  <div class="row mb-4 wow animated fadeInUp" data-wow-delay="0.5s">
    <div class="col-md-8">
      <p class="text-center">
        El 10mo ECSL se llevó a cabo durante las fechas 12, 13, 14 de Julio del 2019. Ahora la sapa pasa a ser de nuestros hermanos guatemantecos en el 11vo ECSL en Guatemala.
      </p>
    </div>
    <div class="col-md-4">
    ...
    <div class="container">
      ...
      <div class="collage">
        ...
        @foreach ($galeria as $i)
          @if ($i < 10)
            <a href="{{'https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_00'.$i.'.jpg'}}" data-toggle="lightbox" data-gallery="gallery-one">
                <img src="{{'https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_00'.$i.'.jpg'}}" class="img-fluid collage-img">
            </a>

          @else
            <a href="{{'https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_0'.$i.'.jpg'}}" data-toggle="lightbox" data-gallery="gallery-one">
                <img src="{{'https://storage.googleapis.com/decimaerp/organizations/15/ECSL_2019_0'.$i.'.jpg'}} " class="img-fluid collage-img">
            </a>
          @endif
        @endforeach
      </div>
